  ...
  <div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="container border">
            ...
            {{-- buat komentar --}}
            <form id="isi_komentar" action="/index/tontonan/{{$id}}/proses" method="post" enctype="multipart/form-data">
                @csrf
